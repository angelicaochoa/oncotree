...
http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/swagger-ui.html <br> The previous version is still available, but is scheduled to be discontinued May 31, 2018
You can continue to access the previous version (v0.0.1) in its original location summarized here: http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/oncotree/swagger-ui.html
 *   **Details and Migration Guidance**
     * The base URL for accessing all API functionality is being simplified from http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/oncotree/ to http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/
     ...
     * Some requests which fail to find matching entities now return NOT_FOUND HTTP status code 404 rather than an empty result. Examples: http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/oncotree_test/api/tumorTypes/search/code/TEST_UNDEFINED_CODE or http://dashi-dev.cbio.mskcc.org:8080/angelica-oncotree/oncotree_test/api/crosswalk?vocabularyId=ICDO&conceptId=C15
#### April 1, 2018
